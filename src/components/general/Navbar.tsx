  ...
  return (
    ...
    >
      <div className="container flex flex-row items-center justify-between gap-10">
        ...
        <div className="hidden flex-row items-center gap-10 xl:flex">
        ...
        <button className="text-4xl xl:hidden" onClick={openSidebar}>
      ...
      <aside
        className={`fixed inset-0 z-20 flex min-h-screen w-64 flex-col gap-6 bg-white px-4 py-6 transition-all duration-300 xl:-translate-x-full ${!isSidebarOpen && "-translate-x-full"}`}
      >
